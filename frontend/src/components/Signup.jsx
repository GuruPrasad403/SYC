...
export default function Signup(){
    ...
    <circle cx="12" cy="7" r="4"></circle>
        ...
        <button type="submit" className=" hover:bg-zinc-600 hover:text-balck w-full text-[#ffffff] bg-[#232327] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Login</button>
        <div className="text-sm font-light text-[#a6a8ac]">Existing User? <a onClick={()=> navigator("/login")} className="font-medium text-[#ffffff] hover:underline hover:cursor-pointer">Sign In</a></div>
    </form>
