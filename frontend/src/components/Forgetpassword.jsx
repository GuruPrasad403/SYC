...
export default function Forgetpassword(){
    ...
    <form className="flex flex-col">
        ...
        <button type="submit" className="w-full text-[#ffffff] bg-[#232327] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6 hover:bg-zinc-600 hover:text-balck">Get Link</button>
