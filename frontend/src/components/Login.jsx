...
export default function Login() {
    ...
    const loginfun = async (e) => {
        e.preventDefault();
        try {
            const res = await signInWithEmailAndPassword(auth, email, passwordlogin)
                ...
                <div className="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#3e3d3d] rounded-2xl shadow-xl">
                    ...
                    <form className="flex flex-col">
                        <div className="pb-2">
                            ...
                            <div className="relative text-gray-400">
                                ...
                                <input type="email" name="name" id="name" onChange={(e) => {
                        ...
                        <div className="pb-6">
                            ...
                            <div className="relative text-gray-400" ref={password}>
                                ...
                                <input type={type} ref={type} name="password" id="password" placeholder="••••••••••" onChange={(e) => {
                                    setpasswordlogin(e.target.value)
                                }} className="pl-12 mb-2 bg-gray-50 text-gray-600 border focus:border-transparent border-gray-300 sm:text-sm rounded-lg ring ring-transparent focus:ring-1 focus:outline-none focus:ring-gray-400 block w-full p-2.5 rounded-l-lg py-3 px-4" autoComplete="new-password" aria-autocomplete="list" />
                            </div>
                        </div>
                        <button type="submit" onClick={loginfun} className="w-full hover:bg-zinc-600 hover:text-balck text-[#ffffff] bg-[#232327] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Login</button>
                    ...
                    <form>
                        <div className="flex flex-row gap-2 justify-center">
                            <button onClick={googleLogin} className="flex flex-row w-32 gap-2 hover:bg-white hove:text-black bg-gray-600 p-2 rounded-md text-gray-200">
